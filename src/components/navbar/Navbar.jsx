        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-14 flex items-baseline space-x-4">
              <Link
                to="/About"
                className="text-[16px] mr-8 mt-4 font-inter font-bold text-gray-800 pb-4 transition-colors duration-300 tracking-wider hover:text-lime-800 hover:border-b-4 border-lime-700"
              >
                ABOUT US
              </Link>
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <svg className= "mr-8" viewBox="0 0 22 20"  width="26" height="26" fill='#4b5563'>
