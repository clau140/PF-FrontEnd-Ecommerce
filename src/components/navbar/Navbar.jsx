        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              <Link to="/SignIn">
                <button className="bg-white border-[1px] border-green-500 font-inter text-black px-3 py-2 rounded-md text-sm font-medium mr-8 hover:bg-green-500 hover:text-white transform hover:scale-110 transition duration-200">
                  Ingresar
                </button>
              </Link>
              <Link to="/SignUp">
                <button className=" bg-white border-[1px] border-green-500 font-inter text-black font-inter px-3 py-2  mr-8 rounded-md text-sm font-medium hover:bg-green-500 hover:text-white transform hover:scale-110 transition duration-200">
                  Únete
                </button>
              </Link>
              <svg
              ...
              <svg viewBox="0 0 22 22" width="28" height="28" fill="#10B981">
